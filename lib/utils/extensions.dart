...
import 'package:obh_lawyer/core/routes/route.dart';
import 'package:obh_lawyer/core/service/remote/error_message_model.dart';
import 'package:obh_lawyer/core/themes/app_sizes.dart';
import 'package:obh_lawyer/core/themes/app_text_styles.dart';
import 'package:obh_lawyer/core/themes/app_theme.dart';
import 'package:obh_lawyer/core/themes/data.dart';
import 'package:obh_lawyer/core/utilities/locale.dart';
import 'package:obh_lawyer/core/utilities/translation.dart';
...
extension LocalizedErroMessage on ErrorMessageModel {
  String getValueByCurrentLanguage(BuildContext context) {
    // Get the current locale language code using EasyLocalization
    final currentLanguage = context.locale;
...
extension ListToText on List {
  String transformToText() {
    // transfor a list of strings into (-) seperated text
     return toString()
                  .replaceAll('[', '')
                  .replaceAll(']', '')
                  .replaceAll(',', ' - ');
